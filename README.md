...
## Skills:
[![My Skills](https://skillicons.dev/icons?i=aws,azure,react,androidstudio,bootstrap,c,cpp,css,django,docker,fastapi,figma,firebase,flask,git,hibernate,html,java,js,jquery,linux,maven,mongodb,mysql,nodejs,octave,php,py,r,spring,sqlite,selenium,&perline=15)](https://skillicons.dev)
